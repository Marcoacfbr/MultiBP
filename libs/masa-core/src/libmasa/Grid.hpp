...
public:
	...
	void getBlockPositionMulti(int bx, int by, int* i0, int* j0, int* i1=NULL, int* j1=NULL) const;
...
private:
	...
	void getBlockPositionHMulti(int bx, int by, int* j0, int* j1) const;
